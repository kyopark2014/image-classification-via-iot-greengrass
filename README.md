...
아래와 같이 머신러닝을 이용하여 IoT 디바이스에서 이미지 분류를 수행하는 2가지 방법에 대해 설명합니다. 여기서 사용하는 [DLR (Deep Learning Runtime)](https://github.com/neo-ai/neo-ai-dlr) 머신러닝 모델은 [ResNet-50 모델](https://viso.ai/deep-learning/resnet-residual-neural-network/)을 Greengrass에 맞게 최적화하는 모델입니다. 
