...
[DLR (Deep Learning Runtime)](https://github.com/neo-ai/neo-ai-dlr)을 이용하여 Greengrass에서 Built-in으로 제공하는 public component인 [aws.greengrass.DLRImageClassification](https://docs.aws.amazon.com/greengrass/v2/developerguide/dlr-image-classification-component.html)은 IoT 디바이스에서 이미지 분류를 할 수 있도록 해줍니다. aws.greengrass.DLRImageClassification을 설치하고, 활용하는 방법에 대한 상세한 설명은 [Built-in Component를 이용하여 IoT 디바이스에서 이미지 분류하기](https://github.com/kyopark2014/image-classification-via-iot-greengrass/blob/main/README.md)를 참조합니다. 
