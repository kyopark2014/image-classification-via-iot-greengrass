...
Greengrass에서 Built-in으로 제공하는 public component인 [aws.greengrass.DLRImageClassification](https://docs.aws.amazon.com/greengrass/v2/developerguide/dlr-image-classification-component.html)으로 IoT 디바이스에서 이미지 분류를 솜쉽게 구현할 수 있습니다. [[Built-in Component를 이용하여 IoT 디바이스에서 이미지 분류하기]](https://github.com/kyopark2014/image-classification-via-iot-greengrass/blob/main/README.md)에서는 aws.greengrass.DLRImageClassification을 설치하고, 활용하는 방법에 대해 상세히 설명하고 있습니다.
